...
<html lang="es">
    ...
    <div class="card border-0 shadow-sm p-4 bg-white rounded-4 mb-5">
        ...
        <form action="${baseUrl}/FrontController" method="POST" class="row g-3 align-items-end">
            ...
            <div class="col-md-4">
                <label class="form-label small fw-bold text-muted">Producto o Marca</label>
            ...
            <div class="col-md-3">
                ...
                <select name="idcategoria" class="form-select border-0 bg-light">
                    <option value="">Todas las Categorías</option>
                    <c:forEach var="cat" items="${categoriasGlobales}">
                        <option value="${cat.idcategoria}" ${param.idcategoria == cat.idcategoria ? 'selected' : ''}>${cat.nombre}</option>
                    </c:forEach>
                </select>
            </div>
                                ...
                                <div class="card-body d-flex flex-column pt-3">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="${baseUrl}/FrontController?accion=verCarrito&accionCarrito=agregar&idProducto=${produ.idproducto}" 
                                               class="btn btn-rebex w-100 rounded-3">
