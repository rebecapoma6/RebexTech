        ...
        <div class="container my-5 pt-4">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <%-- CARTEL DE ÉXITO (Solo sale si existe 'totalFinal') --%>
                    ...
                    <div class="factura-container ticket-bg">
                        <div class="header-factura p-4">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-md-end mt-3 mt-md-0">
                                    ...
                                    <span class="badge bg-secondary px-3 py-2 rounded-pill">Pedido #${idPedidoGenerado != null ? idPedidoGenerado : 'N/A'}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-5">
                                    <div class="bg-total-factura p-4 rounded-3 bg-light border">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <span class="h4 fw-bold text-morado-rebex mb-0"><fmt:formatNumber value="${totalPrecio}" minFractionDigits="2" />€</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-white p-4 no-print text-center border-0 rounded-bottom-4">
                            <form action="${baseUrl}/FrontController" method="POST" style="margin: 0;">
                                <input type="hidden" name="accion" value="inicio">
                                <button type="submit" class="btn btn-rebex px-5 fw-bold shadow-sm">
                                    VOLVER A LA TIENDA
                                </button>
                            </form>
                        </div>
